                            ...
                            <div class="member-info">
                                ...
                                <div class="social-touch">
                                    ...
                                    <div class="linkedin-touch">
                                        <button class="btn btn-primary" @click="addcart" :data-lid="item.lid"
                                                :data-price="item.price" :data-title="item.title" type="warning">加入购物车
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <el-row :gutter="10">
                <el-col :xs="24" :sm="24" :md="24" :lg="24">
                    <div style="display: flex; width: 100%">
                        ...
                        <div style="display: flex;flex-wrap: wrap; position: absolute;width: 1000px;height: 700px;top: 90px;left: 488px">
